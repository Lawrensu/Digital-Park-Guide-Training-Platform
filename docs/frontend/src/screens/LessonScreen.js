    ...
    <View style={{ flex: 1, backgroundColor: '#111827' }}>
      ...
      {currentLesson.videoUrl ? (
        <View style={{
          ...
          <Text style={{ color: '#fff', fontSize: 14, fontWeight: '600', fontFamily: FONTS.title }}>
            Video Lesson
          </Text>
          <Text style={{ color: 'rgba(255,255,255,0.5)', fontSize: 11, marginTop: 4, fontFamily: FONTS.body }}>
