			...
			<main className="flex-1 p-4 sm:p-6 lg:p-8 box-border">
				...
				<div className="mb-8 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
					...
					{!isEnrolled && (
						<button
							...
							className="py-2 px-6 bg-[#2E7D32] text-white border-0 rounded-lg text-[0.95rem] font-semibold cursor-pointer transition-colors duration-200 hover:bg-[#1B5E20] disabled:opacity-50"
						>
				...
				<div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-8 items-start">
					...
					<div className="flex flex-col gap-4">
						{!isEnrolled && (
							<div className="bg-[#FFF3E0] border-l-4 border-l-[#FFB74D] p-5 rounded-sm text-[#E65100] text-[0.9rem] leading-normal flex gap-3 items-start mb-2">
						...
						{items.map((item, index) => {
							...
							return (
								<div
									...
									className={`bg-white p-5 rounded-lg flex items-center gap-4 border border-[#E0E0E0] transition-all duration-200
									...
									`}
								>
									<div className={`w-10 h-10 rounded-lg flex items-center justify-center text-[1.25rem] shrink-0 ${isDone ? 'bg-[#E0E0E0] text-[#757575]' : 'bg-[#E8F5E9] text-[#2E7D32]'}`}>
					...
					<div>
						...
						<div className="bg-white p-6 rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.05)] mb-6">
						...
						{isEnrolled && totalItems > 0 && (
							<div className="bg-[#FFF3E0] border-l-4 border-l-[#FFB74D] p-5 rounded-sm text-[#E65100] text-[0.9rem] leading-normal flex gap-3 items-start">
