			...
			<div className="bg-white rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.08)] p-10 w-full max-w-lg">
				...
				<form onSubmit={handleSubmit} className="flex flex-col gap-5">
					<div className="grid grid-cols-2 gap-4">
						...
						<div className="flex flex-col gap-1.5">
							<label className="[font-family:var(--font-outfit)] text-[13px] font-medium text-[#1c1917]">Last Name</label>
							<input
								type="text" required
								value={form.lastName}
					...
					<div className="flex flex-col gap-1.5">
						<label className="[font-family:var(--font-outfit)] text-[13px] font-medium text-[#1c1917]">Email Address</label>
						<input
							type="email" required
							value={form.email}
							onChange={set('email')}
					...
					<div className="flex flex-col gap-1.5">
						<label className="[font-family:var(--font-outfit)] text-[13px] font-medium text-[#1c1917]">IC / Passport Number</label>
						<input
							type="text" required
					...
					<div className="flex flex-col gap-1.5">
						<label className="[font-family:var(--font-outfit)] text-[13px] font-medium text-[#1c1917]">Address</label>
						<textarea
							required rows={3}
							value={form.address}
					...
					<div className="flex flex-col gap-1.5">
						<label className="[font-family:var(--font-outfit)] text-[13px] font-medium text-[#1c1917]">Reason for Applying</label>
						<textarea
							required rows={4}
					...
					<button
						type="submit"
						disabled={loading}
						className="mt-2 py-[13px] bg-[#1a3a2a] text-white [font-family:var(--font-outfit)] text-[15px] font-semibold rounded-lg cursor-pointer transition-colors hover:bg-[#1f4d35] disabled:opacity-50 disabled:cursor-not-allowed"
					>
