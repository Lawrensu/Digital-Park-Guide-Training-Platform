                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white rounded-xl border border-[#d4e4da] p-6">
                        <div className="flex items-center justify-between mb-5">
                            <div>
                                <h2 className="font-outfit text-[17px] font-semibold text-[#1a3a2a]">Park Stations</h2>
                                <p className="font-outfit text-sm text-[#5a7a6a] mt-0.5">SFC park locations that guides are assigned to.</p>
                            </div>
                            <button
                        ...
                        {deleteError && <p className="font-outfit text-xs text-red-500 mb-3">{deleteError}</p>}

                        {isLoading && <p className="font-outfit text-sm text-[#5a7a6a] py-4 text-center">Loading stations…</p>}
                        {error && <p className="font-outfit text-sm text-red-500 py-4 text-center">Failed to load stations.</p>}
            ...
            {(showAddModal || editTarget) && (
                <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
                    <div className="bg-white rounded-xl p-6 w-full max-w-md shadow-xl">
                        <h3 className="font-outfit text-[17px] font-semibold text-[#1a3a2a] mb-4">
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2.5 border border-[#d4e4da] rounded-lg font-outfit text-sm focus:outline-none focus:border-[#266841] mb-3"
                        />
