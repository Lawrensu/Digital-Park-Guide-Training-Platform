				...
				<main className="flex-1 p-4 sm:p-6 lg:p-8 flex flex-col gap-5 overflow-y-auto">
					...
					<div className="flex gap-2">
						{TABS.map(tab => (
							<button
								key={tab}
								className={`py-1.75 px-5 rounded-full font-outfit text-[13px] font-medium border border-[#d6d3d1] bg-white text-[#44403c] cursor-pointer transition-all duration-150 hover:border-[#1a3a2a] hover:text-[#1a3a2a] ${activeTab === tab ? 'bg-[#1f4d35] border-[#1f4d35] text-white hover:text-white' : ''}`}
