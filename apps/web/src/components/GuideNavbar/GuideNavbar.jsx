            ...
            */}
            ...
            <header className="lg:hidden fixed top-0 inset-x-0 h-14 bg-[#1a3a2a] z-30 flex items-center px-4 gap-3 shadow-md">
                <button
                    ...
                    className="w-9 h-9 flex items-center justify-center rounded-lg bg-white/[0.08] border border-white/[0.15] text-white cursor-pointer hover:bg-white/[0.14] transition-colors"
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="[font-family:var(--font-outfit)] text-[14px] font-semibold text-white">SFC Park Guide</span>
                </div>
                {unreadCount > 0 && (
                    <NavLink
